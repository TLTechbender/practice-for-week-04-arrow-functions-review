...
// one line? No I can't do this, but I gon learn
//
const coupon2 = discount => prices => prices.map(price => price -= price * discount);

console.log('coupon2 output:');
console.log(coupon2(0.5)([10, 6, 3, 9]));
